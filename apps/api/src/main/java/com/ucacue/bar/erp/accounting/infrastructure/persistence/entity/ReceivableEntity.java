...
@Entity
@Table(name = "acc_receivables", indexes = {
        @Index(name = "idx_acc_receivables_tenant_status", columnList = "tenant_id,status"),
        @Index(name = "idx_acc_receivables_source", columnList = "source_document_type,source_document_id")
})
@Getter
@Setter
@NoArgsConstructor
